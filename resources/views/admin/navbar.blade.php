    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"" href="{{url('/viewchef')}}" aria-expanded="false" aria-controls="icons">
              <span class="menu-title">Chefs</span>
              <i class="mdi mdi-contacts menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="{{url('/viewreservation')}}" aria-expanded="false" aria-controls="icons">
